...
#             loss_ssim = (1 - self.criterionSSIM(output_gen, im_faces[0]))
            ...
            loss_G = loss_G_gan + loss_G_siam + loss_L1
            loss_G.backward()
...
def run_exp(TRAIN_PARAMS):
    ...
    ##### PREPARING MODELS
    ch_inp_num = 11
    generator = load_model(model_dir, model_name, 'Generator', device_comp, TRAIN_PARAMS['ARCH_NUM'], epoch_start = TRAIN_PARAMS['EPOCH_START'], ch_inp_num = 11, label_num=label_num)
    critic = load_model(model_dir, model_name, 'Discriminator', device_comp, TRAIN_PARAMS['ARCH_NUM'], epoch_start = TRAIN_PARAMS['EPOCH_START'], ch_inp_num = 14)
