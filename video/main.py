...
import time
sys.path.append('/home/qiuyang/anonymous/ciagan_semantic')
sys.path.append('/home/qiuyang/anonymous/ciagan_semantic/source')
...
Generator_model_path ='/home/junjie/DeIDVideo/SemanticImageSynthesis/ciagan_semantic/models/ciagan_Aspade_feature_flex_DCeleBA_Tcheckhyperparameters_att__unitloss_sknoise/Aspade_feature_flex_DCeleBA_Tcheck_ep01000G.pth'
# Generator_model_path = '/home/qiuyang/anonymous/ciagan_semantic/models/on_Adience/ciagan_Aspade_feature_flex_DAdience_train_Tcheck_on_Adience/Aspade_feature_flex_DAdience_train_Tcheck_on_Adience_ep00500G.pth'
...
def generate_clr(img_path,detector,predictor):
    ...
    res_h = 256
    gray = False
    img = cv2.imread(img_path,cv2.cv2.IMREAD_ANYCOLOR)
    if len(img.shape)==2:
        gray = True
...
class EAGR_predictor():
    ...
    def __init__(self) -> None:
        ...
        restore_from = '/home/qiuyang/anonymous/ciagan_semantic/source/EAGRNet/snapshots/helen2021-08-15T08-59-08/best.pth'
...
class new_model(nn.Module):
    def __init__(self,output_layer = None):
        ...
        checkpoint = torch.load("/home/junjie/DeIDVideo/SemanticImageSynthesis/ciagan_semantic/faceAttribute/checkpoints/model_best.pth.tar")
...
def return2org(i,pos,visual_shape,img_pad,img_GAN,clr,img):
    ...
    cv2.imwrite('/home/qiuyang/anonymous/ciagan_semantic/source/video/test_result/return_img_p.jpg',img_p)
    cv2.imwrite('/home/qiuyang/anonymous/ciagan_semantic/source/video/test_result/return_img.jpg',img)
    return img
...
def prepare_traindata(EAGR_model):
    root_path = '/home/qiuyang/anonymous/ciagan_semantic/dataset/Adience_train/clr'
...
if __name__ == '__main__':
    img_path = '/home/qiuyang/anonymous/ciagan_semantic/source/video/test_images/multiple/29_Students_Schoolkids_Students_Schoolkids_29_3.jpg'
    dir = '/home/qiuyang/anonymous/ciagan_semantic/dataset/FGNETT'
    out_dir = '/home/qiuyang/anonymous/ciagan_semantic/source/video/test_result/FGNET'

    dlib_detector = dlib.get_frontal_face_detector()
    dlib_predictor = dlib.shape_predictor(dlib_path+"shape_predictor_68_face_landmarks.dat")
