...
Generator_model_path ='./models/Aspade_feature_flex_DCeleBA_Tcheck_ep01000G.pth'
...
class EAGR_predictor():
    ...
    def __init__(self) -> None:
        ...
        restore_from = './source/EAGRNet/best.pth'
...
class new_model(nn.Module):
    def __init__(self,output_layer = None):
        ...
        checkpoint = torch.load("./faceAttribute/checkpoints/model_best.pth.tar")
...
def return2org(i,pos,visual_shape,img_pad,img_GAN,clr,img):
    ...
    cv2.imwrite('./source/video/test_result/return_img_p.jpg',img_p)
    cv2.imwrite('./source/video/test_result/return_img.jpg',img)
    return img
...
def prepare_traindata(EAGR_model):
    root_path = './dataset/Adience_train/clr'
...
if __name__ == '__main__':
    ...
    # dir = './dataset/FGNET/'
    dir = './dataset/gender/'
    # out_dir = './dataset/FGNET/'
    out_dir = './dataset/result/'

    dlib_detector = dlib.get_frontal_face_detector()
    dlib_predictor = dlib.shape_predictor("./source/shape_predictor_68_face_landmarks.dat")
